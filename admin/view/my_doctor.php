...
if (!isset($_GET['kw'])) {
  $total_num = tb_doctor::query_doctor_total_num("employe_id='$employe_id'");
  $doctor_rows = tb_doctor::query_doctor_limit("employe_id='$employe_id'",
      'id desc',
      ($page - 1) * 10,
      10);
