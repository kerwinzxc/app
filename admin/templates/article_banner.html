...
function submitValidate($new_one)
{
...
<div style="margin:35px 130px 0 130px;">
  <div class="input_form">
    <form action={if $new_one eq 1}"view/add_article_banner.php"{else}"view/article_banner.php"{/if} method="post" enctype="multipart/form-data" onsubmit="return submitValidate({$new_one})">
      <table>
